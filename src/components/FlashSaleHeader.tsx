export default function FlashSaleHeader() {
  return (
    <div 
      className="pt-[10px] pr-[20px] pb-[10px] pl-[20px] gap-[10px] flex items-center justify-center text-white md:[background:linear-gradient(90deg,_#FC004E_0%,_#10CBE0_100%)]"
      style={{ 
        minHeight: '46px',
